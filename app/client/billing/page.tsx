  ...
  if (!orgId) {
    return (
      <div className="space-y-4">
        ...
        <Link href="/client/setup" className="inline-block rounded-lg bg-site-primary px-4 py-2 text-white hover:opacity-90">업체 설정</Link>
      </div>
    );
  }
      ...
      <section className="rounded-lg border border-site-border bg-site-card p-6">
        ...
        <ul className="mt-3 space-y-1 text-sm">
          ...
          <li>
            ...
            {" · "}
            <span className={annualMembershipStatus === "ACTIVE" ? "text-green-600" : annualMembershipStatus === "EXPIRED" ? "text-amber-600" : "text-gray-500"}>
