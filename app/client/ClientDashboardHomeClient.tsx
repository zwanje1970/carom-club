...
function DashboardSkeleton() {
  return (
    <div className="v3-stack" style={{ gap: "1.15rem" }} aria-busy="true" aria-label="대시보드 내용 불러오는 중">
      <section className="v3-stack client-dashboard-main__cta" aria-hidden>
        <div className="v3-h2 skeleton-line" style={{ margin: 0, fontSize: "1rem", height: "1.1rem", width: "55%", borderRadius: 6, background: "#e5e7eb" }} />
        <div className="skeleton-line" style={{ height: "0.95rem", width: "85%", borderRadius: 6, background: "#e5e7eb" }} />
        <div className="skeleton-line" style={{ height: "2.25rem", width: "9rem", borderRadius: 8, background: "#e5e7eb" }} />
      </section>
...
export default function ClientDashboardHomeClient() {
  ...
  if (!d.hasOrgSetup) {
    ...
    mainButtonHref = d.firstTournamentId
