  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-gray-600">
        대회별 경기 결과 입력·진출자 확정은 각 대회의 결과 탭에서 진행할 수 있습니다.
      </p>
        ...
        <ul className="space-y-2">
          {tournaments.map((t) => (
            ...
            >
              ...
              <span className="text-sm text-gray-500">{STATUS_LABEL[t.status] ?? t.status}</span>
              <Link
                href={`/client/tournaments/${t.id}/results`}
