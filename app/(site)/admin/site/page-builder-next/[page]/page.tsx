...
export default async function AdminSitePageBuilderNextByPage({ params }: Props) {
  ...
  return (
    <PageBuilderClient
      terminology="block"
      draftToolbar
      initialPage={page as PageBuilderKey}
      builderBasePath="/admin/site/page-builder-next"
    />
  );
}
