...
import { getUserById, restoreMainSlideAdByIdForPlatformBackup } from "../../../../../../../../lib/platform-api";
...
export async function POST(_request: Request, context: { params: Promise<{ adId: string }> }) {
  ...
  const result = await restoreMainSlideAdByIdForPlatformBackup(id);
