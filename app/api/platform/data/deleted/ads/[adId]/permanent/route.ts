...
import { getUserById, permanentlyDeleteMainSlideAdByIdForPlatformBackup } from "../../../../../../../../lib/platform-api";
...
export async function POST(request: Request, context: { params: Promise<{ adId: string }> }) {
  ...
  const result = await permanentlyDeleteMainSlideAdByIdForPlatformBackup(id, confirmText);
