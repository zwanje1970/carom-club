...
import { getUserById, permanentlyDeleteCommunityPostByIdForPlatformBackup } from "../../../../../../../../lib/platform-api";
...
export async function POST(request: Request, context: { params: Promise<{ postId: string }> }) {
  ...
  const result = await permanentlyDeleteCommunityPostByIdForPlatformBackup(id, confirmText);
