...
import { demoteParticipantConfirmationFirestore } from "../../../../../../../lib/server/firestore-tournament-applications";
...
export async function POST(_request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  const result = await demoteParticipantConfirmationFirestore({
    tournamentId,
    zoneIdsFilter,
  });
  ...
  return NextResponse.json({ ok: true as const, demoted: result.demoted });
}
