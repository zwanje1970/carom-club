...
import { revertMultiBlockBracketToSingleFirestore } from "../../../../../../../lib/server/firestore-tournament-brackets";
import {
...
export async function POST(request: NextRequest, context: { params: Promise<{ id: string }> }) {
  ...
  const result = await revertMultiBlockBracketToSingleFirestore({
    tournamentId,
