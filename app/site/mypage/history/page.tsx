...
import { loadMypageApplicationsHistoryBundleForUserId } from "../../../../lib/server/site-mypage-applications-history-bundle";
...
export default async function SiteMypageHistoryPage() {
  ...
  const bundle = await loadMypageApplicationsHistoryBundleForUserId(session.userId);

  return (
    <SiteShellFrame brandTitle="지난 대회">
      <section className="site-site-gray-main v3-stack site-mypage-shell">
        <MypageApplicationsDeferred initialApplicationRows={bundle.applicationRows} />
        ...
        <section className="card-clean site-detail-inner-stack">
          ...
          <MypageHistoryDynamicMount initialHistoryRows={bundle.historyRows} />
        </section>
