...
const CardBoxTransaction = (props: Props) => {
  ...
  const typeColor = (): "danger" | "success" | "warning" | "info" => {
    ...
    <CardBox className="mb-6 last:mb-0">
      <div className="flex flex-col items-center justify-between md:flex-row">
        <div className="mb-6 flex flex-col items-center justify-start md:mb-0 md:flex-row">
          <IconRounded icon={icon ?? mdiCreditCard} color={typeColor()} className="mb-6 md:mr-6 md:mb-0" />
        ...
        <div className="space-y-2 text-center md:text-right">
          <p className="text-sm text-gray-500">{props.transaction.name ?? props.transaction.client}</p>
          <div>
